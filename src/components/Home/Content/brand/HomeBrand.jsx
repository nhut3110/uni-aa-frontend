        ...
        <div className="center force">
          <div className="brand__column">
            <h2 className="brand__h2">
              <span className="line__one">
                When ambition
                <br />
              </span>

              <span className="line__two">
                meets opportunity,
                <br />
              </span>
              <strong>
                <span className="line__three">
                  anything <br />
                </span>
            ...
            <p className="text__desc">
              At VNUK, you can explore ideas that interest you, find people who
              inspire and challenge you, and make discoveries that change your
              life—and the world.
            </p>
          </div>
        </div>
